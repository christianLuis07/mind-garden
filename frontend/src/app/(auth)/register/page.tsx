...
import { Sprout, ArrowRight, Mail, Lock, User, AlertCircle, Eye, EyeOff } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-background overflow-hidden p-4 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Tumbuhkan ketenangan dalam dirimu</p>
        </div>
        ...
        <Card className="glass-card border-none shadow-2xl rounded-[2.5rem] overflow-hidden">
          <CardHeader className="pt-10 pb-2 text-center">
            ...
            <CardDescription>Bergabunglah dengan komunitas MindGarden hari ini</CardDescription>
          </CardHeader>
              ...
              >
                {isLoading ? (
                  <span className="flex items-center gap-2">
                    <Spinner className="w-5 h-5" /> Mendaftar...
                  </span>
                ) : (
