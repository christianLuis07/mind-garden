...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Footer */}
      <footer className="bg-[#18241D] text-[#E8EFEA] py-16 border-t border-[#26372D]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-10">
            {/* Brand */}
            <div className="md:col-span-2">
              <Link href="/" className="inline-flex items-center space-x-3 group mb-5">
                <div className="w-11 h-11 bg-primary rounded-2xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-500 shadow-xl shadow-primary/25">
              ...
              <p className="text-[#95A79E] max-w-md text-base leading-relaxed font-normal">
            ...
            {/* Links */}
            <div>
              <h3 className="font-bold text-sm tracking-widest uppercase text-white/90 mb-5">Product</h3>
              <ul className="space-y-3 text-[#95A79E] text-sm">
                <li>
                  <a
                    href="#features"
            ...
            <div>
              <h3 className="font-bold text-sm tracking-widest uppercase text-white/90 mb-5">Company</h3>
              <ul className="space-y-3 text-[#95A79E] text-sm">
                <li>
                  <a
                    href="/about"
          ...
          <div className="border-t border-[#26372D] mt-14 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="flex flex-wrap items-center gap-2 text-sm text-[#95A79E] text-center md:text-left">
                <span>Designed & Engineered by</span>
                <a
                  href="https://github.com/christianLuis07"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-white font-semibold hover:text-primary transition-colors underline decoration-dotted underline-offset-4"
                >
                  Christian Luis Paskalis Ginting
                </a>
                <span className="text-[#394F42] hidden sm:inline">•</span>
                <span className="text-xs text-[#7B9084] hidden sm:inline">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-xl bg-[#23332A] hover:bg-primary text-[#A3B5AC] hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-md"
            ...
            <div className="text-[#6D8075] text-xs text-center mt-6">
